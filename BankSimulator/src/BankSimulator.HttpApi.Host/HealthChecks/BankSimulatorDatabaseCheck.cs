...
public class BankSimulatorDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public BankSimulatorDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
