...
namespace BankSimulator.Migrations
{
    ...
    [Migration("20240908120150_Updated_Transaction_24090815013577")]
    partial class UpdatedTransaction24090815013577
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BankSimulator.Accounts.Account", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("BankSimulator.Accounts.AccountCustomerInfoFile", b =>
                {
                    b.Property<Guid>("AccountId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("CustomerInfoFileId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("AccountId", "CustomerInfoFileId");

                    b.HasIndex("CustomerInfoFileId");

                    b.HasIndex("AccountId", "CustomerInfoFileId");

                    b.ToTable("AppAccountCustomerInfoFile", (string)null);
                });

            modelBuilder.Entity("BankSimulator.CustomerInfoFiles.CustomerInfoFile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppCustomerInfoFiles", (string)null);
                });

            modelBuilder.Entity("BankSimulator.Transactions.Transaction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BankSimulator.Accounts.AccountCustomerInfoFile", b =>
                {
                    b.HasOne("BankSimulator.Accounts.Account", null)
                        .WithMany("CustomerInfoFiles")
                        .HasForeignKey("AccountId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("BankSimulator.CustomerInfoFiles.CustomerInfoFile", null)
                        .WithMany()
                        .HasForeignKey("CustomerInfoFileId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("BankSimulator.Accounts.Account", b =>
                {
                    b.Navigation("CustomerInfoFiles");
                });
